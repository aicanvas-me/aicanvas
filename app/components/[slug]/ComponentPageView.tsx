          ...
          <div ref={mainCardRef} className="overflow-hidden rounded-2xl border border-sand-200 bg-sand-100 shadow-sm dark:border-sand-800 dark:bg-sand-900 dark:shadow-none">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.18 }}
                className="absolute inset-0 overflow-y-auto overflow-x-hidden bg-sand-50 p-5 transition-colors duration-300 [scrollbar-color:#C4BFB7_transparent] dark:bg-sand-950 dark:[scrollbar-color:#4A453F_transparent]"
                style={{
                  scrollbarWidth: 'thin',
