...
export const metadata = {
  ...
  description:
    'The Andromeda Pro primitives: the depth-numbered neutral ladder, four hue families, the Manrope typeface and the paired type ramp, the spacing grid and the three-layer token architecture every component is built on.',
