...
import { SignUp } from '../../../../lib/andromeda-pro-examples.generated'
...
// Install / Unlock-with-Premium CTA + auth), and renders the composition either
...
export default async function SignUpTemplate({
  ...
  return (
    ...
    <TemplatePreviewShell
      frame={frame}
      templateSlug="andromeda-pro-sign-up"
